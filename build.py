...
CONTACT = {
    ...
    "whatsapp": "+55 (85) 99662-1818",
    "whatsapp_url": "https://wa.me/5585996621818",
...
ICONS = {
    ...
    "whatsapp": '<path d="M12 3.5a8.5 8.5 0 0 0-7.3 12.9L3.5 20.5l4.2-1.1A8.5 8.5 0 1 0 12 3.5Z"/><path d="M9.2 8.6c.2-.5.6-.5 1-.5l.7 1.6-.6.8c.6 1.2 1.6 2.2 2.8 2.8l.8-.6 1.6.7c0 .4 0 .8-.5 1-2.7.7-6.5-3.1-5.8-5.8Z"/>',
}
