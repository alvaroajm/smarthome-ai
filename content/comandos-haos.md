...
slug: comandos-haos
description: Referência prática do CLI `ha`, do terminal Alpine do add-on SSH e dos comandos de diagnóstico que resolvem 90% dos problemas do Home Assistant.
category: Referência
icon: terminal
order: 11
featured: true
