...
DEVICES = [
 ('bulb','Lâmpadas inteligentes','Smart bulbs','light','Zigbee',
 ...
 ('esp32','Projetos com ESP32','ESP32 projects','control','ESPHome · Wi-Fi',
...
def server_section(lang):
 ...
 <div class="server-platforms">
  <article class="server-platform"><a class="server-brand" href="https://casaos.zimaspace.com/"{ext("https://")} aria-label="CasaOS — {t('site oficial', 'official website')}">{project_icons("casaos")}</a><h3>CasaOS</h3><p>{t('Um painel para gerenciar arquivos e aplicativos em um computador com Linux compatível.', 'A dashboard for files and apps on a computer running compatible Linux.')}</p><div class="platform-links"><a href="https://casaos.zimaspace.com/"{ext('https://')}>{t('Conhecer CasaOS', 'Explore CasaOS')} ↗</a><a href="https://github.com/IceWhaleTech/CasaOS"{ext('https://')}>GitHub ↗</a></div></article>
  <article class="server-platform"><a class="server-brand" href="https://umbrel.com/umbrelos"{ext("https://")} aria-label="umbrelOS — {t('site oficial', 'official website')}">{project_icons("umbrel")}</a><h3>umbrelOS</h3><p>{t('Um sistema com loja de aplicativos para criar sua nuvem pessoal em hardware compatível.', 'An operating system with an app store for your personal cloud on compatible hardware.')}</p><div class="platform-links"><a href="https://umbrel.com/umbrelos"{ext('https://')}>{t('Conhecer umbrelOS', 'Explore umbrelOS')} ↗</a><a href="https://apps.umbrel.com/"{ext('https://')}>App Store ↗</a></div></article>
 </div>
 <div class="server-ha-note"><strong>{t('E o Home Assistant?', 'And Home Assistant?')}</strong><p>{t('O Home Assistant cuida da automação. CasaOS e umbrelOS cuidam dos arquivos e aplicativos.', 'Home Assistant manages automation. CasaOS and umbrelOS manage files and apps.')}</p><a href="/casaos-umbrel/">{t('Comparar e escolher a instalação', 'Compare installation options (PT)')} →</a></div>
 <details class="gallery-details"><summary>{t("Ver exemplos de computadores", "See example computers")}</summary><header class="hardware-heading"><h3>{t('O hardware por trás das ideias', 'The hardware behind your ideas')}</h3><p>{t('Do Raspberry Pi ao mini-PC: dois formatos para explorar.', 'From Raspberry Pi to mini PC: two formats to explore.')}</p></header><div class="photo-grid hardware-gallery">{photo_gallery(lang,True)}</div></details>
 </div></section>'''
